...
exports.SEED_LECTURES = void 0;
exports.SEED_LECTURES = [
    {
        ...
        lessons: [
            ...
            },
            {
                ...
                answer: 1,
                explanation: "The internet is a huge world for everyone but we explore it carefully!",
                icon: "🧭",
            },
            {
                stepId: "intro-quiz-2",
                ...
                answer: 0,
                explanation: "Always let a trusted adult know when you are online. They keep you safe!",
                icon: "🛡️",
            },
        ],
    },
    {
        ...
        lessons: [
            ...
            },
            {
                ...
                answer: 1,
                explanation: "Blocking and telling a trusted adult is the brave, safe choice.",
                icon: "🚫",
            },
            {
                stepId: "bully-quiz-2",
                ...
                answer: 1,
                explanation: "Supporting a friend and getting help makes you a true defender!",
                icon: "🤝",
            },
        ],
    },
        ...
        lessons: [
            {
                ...
                icon: "🔐",
                mascot: "🦸",
                speech: "Use big, mixed-up words and numbers. Never share your password!",
            },
            {
                stepId: "pass-quiz-1",
                type: "quiz",
                ...
                answer: 2,
                explanation: "Long, mixed words and numbers make a super-strong password!",
                icon: "💪",
            },
            {
                stepId: "pass-quiz-2",
                ...
                answer: 1,
                explanation: "Keep passwords private even from friends. You are the Keeper!",
                icon: "🤫",
            },
        ],
    },
    {
        ...
        lessons: [
            ...
            },
            {
                ...
                answer: 1,
                explanation: "A favorite color is fun and safe. Address and school stay private!",
                icon: "🎨",
            },
            {
                stepId: "priv-quiz-2",
                ...
                answer: 1,
                explanation: "Never send photos to strangers. Tell a trusted adult right away.",
                icon: "📸",
            },
        ],
    },
